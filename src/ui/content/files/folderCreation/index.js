...
import './index.css';
import { encryptBlob, importAndDeriveKeyFromRaw } from "../../../../lib/crypto/encrypt";
...
export class Foldercreation extends React.Component {
    ...
    create = async()=>{
        ...
        var encryptedFolderName = new Uint8Array(await encryptBlob(folderNameAb, folderKey, false, clientIV))
            ...
            <div className="folderCreationArea">
                    ...
                    <div className="body">
                        <div className="nameInput">
                            Name
                            <input type="text" placeholder="Folder Name" ref={this.inputVal}></input>
                        </div>
                        <div className="buttons">
                            <div className="creationBtn" onClick={this.unMount}>
                                Cancel
                            </div>
                            <div className="creationBtn" style={{backgroundColor:"rgba(255,255,255,0.3)",color: "#000"}} onClick={()=>this.create()}>
                            Create
                            </div>
                        </div>
                    </div>
